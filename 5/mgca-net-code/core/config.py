...
net_arg.add_argument(
    "--use_rwgp", type=str2bool, default=False, help=""
    "use Residual-Weighted Global Pooling in MBFFN. Default: False")
net_arg.add_argument(
    "--rwgp_tau", type=float, default=1.0, help=""
    "temperature parameter for RWGP weighting exp(-residual/tau). Default: 1.0")
net_arg.add_argument(
